...
export function registerWindowActions(): void {
  ...
  Object.assign(w, {
    ...
    selectProfessionalAvatar: merchant.selectProfessionalAvatar,
    toggleProfessionalService: merchant.toggleProfessionalService,
    toggleProfessionalDayOff: merchant.toggleProfessionalDayOff,
    ...
    showCustomerPortal: pub.showCustomerPortal,
    ...
    selectCustomerPortalStatusFilter: pub.selectCustomerPortalStatusFilter,
    openCustomerPortalReschedule: pub.openCustomerPortalReschedule,
    selectCustomerPortalRescheduleDate: pub.selectCustomerPortalRescheduleDate,
